...
app.get('/home', (req, res) => {
  axios.get('http://localhost:3004/product/getallproducts') // Make a GET request to the API endpoint
  .then(response => {
...
app.get('/edit-product/:id', (req, res) => {
  ...
  axios.get(`http://localhost:3004/product/getproductbyid/${productId}`)
    .then(response => {
